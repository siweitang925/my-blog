...
@section('content')
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/links')}}"><i class="fa fa-fw fa-list-ul"></i>友情链接列表</a>
    ...
    <div class="result_wrap">
        <form action="{{url('admin/links')}}" method="post" submit="return checkUrl()">
            <!-- 携带csrf认证 -->
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="link_url" onblur="changeUrl()" value="http://"><span id='url' style="color:red;"></span>
                        </td>
                    </tr>
                    <tr>
