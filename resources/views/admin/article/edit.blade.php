            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_title" required value="{{$field->art_title}}">
                        </td>
                    </tr>
                    <tr>
...
table.add_tab tr td span.uploadify-button-text{color: #FFF; margin:0;}
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img id="thumb_img" src="{{$field->art_thumb}}" style="max-width:100px;max-height:100px;"></img>
                        </td>
                    </tr>
                     <tr>
                        <th>文章标签：</th>
                ...
                <!-- 百度编辑器插件结束 -->
                    ...
                    <tr>
                        <th>设为站长推荐？</th>
                        <td>
                            <input type="radio" name='art_recommend' @if($field->art_recommend==1) checked @endif value='1'>是&nbsp;&nbsp;&nbsp;
                            <input type="radio" name='art_recommend' @if($field->art_recommend==0) checked @endif value='0'>否
                        </td>
                    </tr>
                    <tr>
                        <th></th>
