            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>导航名称：</th>
                        <td>
                            <input type="text" name="nav_name" required value="{{$field->nav_name}}">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="nav_url" value="{{$field->nav_url}}" onblur="changeUrl()" ><span id='url' style="color:red;"></span>
                        </td>
                    </tr>
